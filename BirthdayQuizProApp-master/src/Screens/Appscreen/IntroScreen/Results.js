import {
    ...
    return (
      <ImageBackground
        ...
        <View style={{marginTop: responsiveHeight(7)}}>
          <View>
            <Text
              style={styles.intro_small}>
             QUIZ RESULTS
            </Text>
            <Image source={images.trophy} style={styles.winImage}></Image>
            <Text style={styles.txt_intro}>Congratulations</Text>
            <Text style={styles.txt_intro_2}>on completing the quiz!{'\n'}Here is your performance:</Text>
            <Text style={styles.txt_intro_3}>
              Correct Answers:<Text style={{color: colors.secondary}}> 3 out of 4</Text>{'\n'}
            ...
            <View style={{flexDirection:"row", alignSelf:"center", alignItems:"center", gap:responsiveHeight(.5)}}>
  ...
  const styles = StyleSheet.create({
    ...
    txt_intro_3:{fontSize: responsiveFontSize(2.3),
        color: 'white',
        textAlign: 'center',},
    txt_intro: {
