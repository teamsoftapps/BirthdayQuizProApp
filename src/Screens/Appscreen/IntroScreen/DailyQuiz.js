...
useLayoutEffect(() => {    Animated.timing(progress, {
      toValue: 1,
      duration: 20000,
      ...
      <View style={{marginTop: responsiveHeight(7), alignSelf: 'center'}}>
        <View
          ...
          <View
            ...
            <View>
              <Text style={{color: 'white', fontWeight: '600'}}>150 Coins</Text>
            </View>
          </View>
        </View>
        <View style={{
                borderColor:"white",
                borderWidth:responsiveHeight(.5),
                borderRadius: responsiveHeight(2),
                height:responsiveHeight(4),
                // ,backgroundColor:"red",
                marginBottom: responsiveHeight(2.5),alignItems:'center',justifyContent:'center'
        }}>
            <Text style={{color:'#000',fontSize:responsiveFontSize(2),zIndex:9999,alignSelf:'center',position:'absolute'}}>{displayText}</Text>
        <Animated.View
          style={{
            ...StyleSheet.absoluteFill,
            borderColor:colors.primary,
            borderWidth:remainingSeconds<5?null:responsiveHeight(.3),
            overflow:"hidden",
         ...
         <Image style={[styles.icon,{marginRight:responsiveHeight(1),position:'absolute',alignSelf:'flex-end',right:responsiveWidth(1)}]} source={images.clock}></Image>
        </View>
