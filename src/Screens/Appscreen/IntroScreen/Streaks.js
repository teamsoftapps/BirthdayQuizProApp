      ...
      <View style={{marginTop: responsiveHeight(5),   marginBottom:responsiveHeight(2)}}>
        <View>
          ...
          <Text style={styles.txt_intro_2}>
            On your <Text style={{fontWeight:"bold", color:colors.secondary}}>1-day </Text>streak!{'\n'} Keep it up to earn even more{'\n'}{' '}
            rewards!
          </Text>
          <Text style={[styles.txt_intro_3,{fontSize:responsiveFontSize(2.8), fontWeight:"600"}]}>Current Streak</Text>
          <Text style={styles.streak}>1</Text>
          <Text style={[styles.txt_intro_3,{color:colors.secondary}]}>Day Streaks!</Text>
          <Text style={[styles.txt_intro, {marginBottom:0,marginTop:responsiveHeight(1.4)}]}>Streak Rewards</Text>
